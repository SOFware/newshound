...
RSpec.describe Newshound::Jobs do
  after do
  ...
  describe ".register" do
    it "adds an adapter class to the registry" do
      adapter_class = Class.new(Newshound::Jobs::Base)
  ...
  describe ".source" do
    ...
    context "when given a built-in symbol" do
      it "resolves :que to the Que adapter" do
        source = described_class.source(:que)

        expect(source).to be_a(Newshound::Jobs::Que)
      end
    end
    ...
    context "when given an unregistered symbol" do
      it "raises an error" do
        ...
        }.to raise_error("Invalid job source: unknown_adapter")
      end
    end
